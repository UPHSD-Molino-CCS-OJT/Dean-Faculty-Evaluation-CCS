...
<body class="bg-gradient-to-br from-gray-50 to-teal-50 min-h-screen">
    ...
    <nav class="nav-gradient text-white shadow-2xl sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 py-4">
            <div class="flex justify-between items-center">
                <div class="flex items-center gap-3 sm:gap-4">
                    ...
                    <div class="uppercase">
                        ...
                        <div class="font-medium text-teal-200 text-xs tracking-wide hidden sm:block">College of Computer Studies</div>
                    </div>
                </div>
                <!-- Mobile hamburger -->
                <button onclick="document.getElementById('facultyMobileMenu').classList.toggle('hidden')" class="md:hidden p-2 rounded-lg bg-white/15 hover:bg-white/25">
            ...
            <!-- Mobile menu -->
            <div id="facultyMobileMenu" class="hidden md:hidden border-t border-white/20 mt-4 pt-4 pb-2 space-y-2">
    ...
    <div class="max-w-7xl mx-auto px-3 sm:px-6 py-6 sm:py-8">
        <div class="mb-8 animate-slide-in">
            <h1 class="text-2xl sm:text-4xl font-black text-gray-800 mb-2">Welcome, <?php echo htmlspecialchars(explode(' ', $faculty_name)[0]); ?>!</h1>
            <p class="text-gray-600 text-sm sm:text-base">View your evaluation history and performance ratings.</p>
        </div>
        ...
        <!-- Statistics Cards -->
        <div class="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-6 mb-8 animate-slide-in">
            <div class="stat-card p-4 sm:p-6 rounded-xl shadow-lg card-hover border-2 border-teal-100">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-xs sm:text-sm font-semibold text-gray-600 uppercase tracking-wide">Total Evaluations</p>
                        <p class="text-2xl sm:text-3xl font-black text-teal-800 mt-2"><?php echo $stats['total_evaluations'] ?? 0; ?></p>
                    </div>
                    <div class="w-10 h-10 sm:w-14 sm:h-14 bg-teal-100 rounded-full flex items-center justify-center">
                        <svg class="w-5 h-5 sm:w-7 sm:h-7 text-teal-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="stat-card p-4 sm:p-6 rounded-xl shadow-lg card-hover border-2 border-blue-100">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-xs sm:text-sm font-semibold text-gray-600 uppercase tracking-wide">Average Rating</p>
                        <p class="text-2xl sm:text-3xl font-black text-blue-800 mt-2"><?php echo $stats['avg_rating'] ? number_format($stats['avg_rating'], 2) : 'N/A'; ?></p>
                    </div>
                    <div class="w-10 h-10 sm:w-14 sm:h-14 bg-blue-100 rounded-full flex items-center justify-center">
            ...
            <div class="stat-card p-4 sm:p-6 rounded-xl shadow-lg card-hover border-2 border-green-100">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-xs sm:text-sm font-semibold text-gray-600 uppercase tracking-wide">Highest Rating</p>
                        <p class="text-2xl sm:text-3xl font-black text-green-800 mt-2"><?php echo $stats['highest_rating'] ? number_format($stats['highest_rating'], 2) : 'N/A'; ?></p>
                    </div>
                    <div class="w-10 h-10 sm:w-14 sm:h-14 bg-green-100 rounded-full flex items-center justify-center">
            ...
            <div class="stat-card p-4 sm:p-6 rounded-xl shadow-lg card-hover border-2 border-orange-100">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-xs sm:text-sm font-semibold text-gray-600 uppercase tracking-wide">Lowest Rating</p>
                        <p class="text-2xl sm:text-3xl font-black text-orange-800 mt-2"><?php echo $stats['lowest_rating'] ? number_format($stats['lowest_rating'], 2) : 'N/A'; ?></p>
                    </div>
                    <div class="w-10 h-10 sm:w-14 sm:h-14 bg-orange-100 rounded-full flex items-center justify-center">
        ...
        <div class="bg-white rounded-xl shadow-xl overflow-hidden border border-gray-200 animate-slide-in">
            <div class="bg-gradient-to-r from-teal-600 to-teal-700 px-4 sm:px-6 py-4">
            ...
            <div class="overflow-x-auto">
                <table class="w-full min-w-[600px]">
                    <thead class="bg-gray-50 border-b-2 border-gray-200">
                        <tr>
                            <th class="px-3 sm:px-6 py-3 sm:py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Semester</th>
                            <th class="px-3 sm:px-6 py-3 sm:py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">School Year</th>
                            <th class="px-3 sm:px-6 py-3 sm:py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider hidden sm:table-cell">Total Units</th>
                            <th class="px-3 sm:px-6 py-3 sm:py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Rating</th>
                            <th class="px-3 sm:px-6 py-3 sm:py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider hidden sm:table-cell">Date</th>
                            <th class="px-3 sm:px-6 py-3 sm:py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Action</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-teal-50 transition">
                            <td class="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap">
                                <span class="px-2 sm:px-3 py-1 inline-flex text-xs leading-5 font-bold rounded-full bg-teal-100 text-teal-800">
                                    <?php echo htmlspecialchars($row['semester']); ?>
                                </span>
                            </td>
                            <td class="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap text-sm font-semibold text-gray-700">
                                <?php echo htmlspecialchars($row['school_year']); ?>
                            </td>
                            <td class="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap text-sm text-gray-600 hidden sm:table-cell">
                            ...
                            <td class="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap">
                                <a href="faculty_view_evaluation.php?id=<?php echo $row['id']; ?>" 
                                   class="inline-flex items-center gap-1 sm:gap-2 px-3 sm:px-4 py-2 bg-teal-600 hover:bg-teal-700 text-white text-xs font-bold rounded-lg shadow transition">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="px-4 sm:px-6 py-4 bg-gray-50 border-t-2 border-gray-200">
